...
train_pred <- predict(pls_model, newdata = pw_train_ga[,-length(pw_train_ga)])
...
test_pred <- predict(pls_model, newdata = pw_test_ga[,-length(pw_test_ga)])
...
ext_pred <- predict(pls_model, newdata = pw_ext_ga[,-length(pw_ext_ga)])
