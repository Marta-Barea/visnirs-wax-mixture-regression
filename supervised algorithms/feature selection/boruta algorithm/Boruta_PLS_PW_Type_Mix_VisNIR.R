...
###############################################################################
################### Boruta + Partial Least Squares (PLS) ######################
###############################################################################
...
train_pred <- predict(pls_model, newdata = pw_train_boruta[,-length(pw_train_boruta)])
...
test_pred <- predict(pls_model, newdata = pw_test_boruta[,-length(pw_test_boruta)])
...
ext_pred <- predict(pls_model, newdata = pw_ext_boruta[,-length(pw_ext_boruta)])
